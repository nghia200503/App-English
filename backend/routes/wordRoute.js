...
import { wordList, wordAdd, wordGetById, wordUpdate, wordDelete, wordAddBulk, getUserWords, createUserWord } from '../controllers/wordController.js';
...
router.get('/user/my-words', getUserWords);
router.post('/user/create', createUserWord);
