      ...
      <header className="border-b border-gray-200">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-4">
            <a href="/login"><button className="cursor-pointer px-6 py-2 text-blue-600 border border-blue-600 rounded-md hover:bg-blue-50 transition">
              Đăng nhập
            </button></a>
            <a href="/register"><button className="cursor-pointer px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition">
              Đăng ký miễn phí
            </button></a>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-blue-600 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex gap-4 justify-center">
            <a href="/register"><button className="cursor-pointer px-8 py-4 bg-white text-blue-600 rounded-md hover:bg-gray-100 transition font-bold text-lg">
              Đăng ký ngay
            </button></a>
            <a href="/login"><button className="cursor-pointer px-8 py-4 border-2 border-white text-white rounded-md hover:bg-white/10 transition font-bold text-lg">
              Đăng nhập
            </button></a>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="hover:text-white">Học từ vựng</a></li>
                <li><a href="#" className="hover:text-white">Ôn tập</a></li>
                <li><a href="#" className="hover:text-white">Kiểm tra</a></li>
                <li><a href="#" className="hover:text-white">Thống kê</a></li>
              </ul>
            </div>
